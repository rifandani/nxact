...
let hook: RenderHookResult<ReturnType<typeof useCount>, undefined>;
...
describe('useMemoizedFn', () => {
  it('useMemoizedFn should work', () => {
    ...
    expect(currentFn).toEqual(hook.result.current.memoizedFn); // should referenced to the the same object
